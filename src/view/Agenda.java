...
public class Agenda extends JFrame {
	...
	public Agenda() {
		...
		contentPane.setToolTipText("Editar Contatos");
		...
		lblNewLabel.setBounds(429, 71, 32, 14);
		...
		lblNewLabel_2.setBounds(26, 122, 46, 14);
		contentPane.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("E-mail");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_3.setBounds(26, 183, 46, 14);
		contentPane.add(lblNewLabel_3);

		txtId = new JTextField();
		txtId.setBounds(464, 66, 86, 27);
		contentPane.add(txtId);
		txtId.setColumns(10);

		txtNome = new JTextField();
		txtNome.setBounds(79, 66, 270, 27);
		contentPane.add(txtNome);
		txtNome.setColumns(10);

		txtFone = new JTextField();
		txtFone.setBounds(82, 119, 203, 27);
		contentPane.add(txtFone);
		txtFone.setColumns(10);

		txtEmail = new JTextField();
		txtEmail.setBounds(82, 178, 411, 27);
		...
		btnCreate.setBounds(182, 259, 64, 64);
		...
		btnUpdate.setBounds(297, 259, 64, 64);
		...
		btnDelete.setBounds(429, 259, 64, 64);
	...
	/**
	 * Metodo responsavel pela edicao do contato
	 */
		...
		if (confirma == JOptionPane.YES_OPTION) {
			String delete = "delete from contatos where id = ?";
					...
					try {
						...
						int confirmarExcluir = pst.executeUpdate();
						if (confirmarExcluir == 1) {
							JOptionPane.showConfirmDialog(null,"Contato excluido com sucesso");
						}
